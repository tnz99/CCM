...
<nav id="circular_nav" class="circular-nav  the-flora-cnav-bg zoom-in-element">
    ...
    <div class="semi-circle-item"><p class="nav-item nav-item-2"><a class="no-underline text-white font-normal fw-700 fs-20" href="the-laws">The Laws</a></p></div>
    ...
    <div class="semi-circle-item"><p class="nav-item nav-item-4"><a class="no-underline text-white font-normal fw-700 fs-20" href="the-climate">The Climate</a></p></div>
...
</nav><?php /**PATH /var/www/html/resources/views/components/circular_nav.blade.php ENDPATH**/ ?>