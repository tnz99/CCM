<?php $__env->startSection('body_class', 'the-climate'); ?>
...
<section class="d-flex flex-column z-3">
    <div class="text-white ml-139 w-495 mt-148">
        ...
        <h1 class="fs-96 fw-700 lh-normal font-normal">Climate</h1>
        ...
        <div class="d-flex align-items-center justify-content-between mt-46">
            <ul class="d-flex align-items-center justify-content-between list-none p-0 m-0">
                ...
                <li><a href="the-climate-1.html" class="no-underline circle-xm d-flex justify-content-center align-items-center border-0">2</a></li>
            </ul>
...
<?php echo $__env->make('components.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/climate.blade.php ENDPATH**/ ?>